...
Requires PHP `^8.5` (PHP 8.5 or a later PHP 8 release). Composer installs the runtime dependency, `psr/container`.
Install with:
...
```sh
git clone git@github.com:dirthara/container.git
cd container
