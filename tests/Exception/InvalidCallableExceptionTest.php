...
final class InvalidCallableExceptionTest extends TestCase
{
    #[Test]
    public function it_carries_nothing_by_default(): void
    {
        $exception = new InvalidCallableException();
    ...
    public function it_keeps_a_previous_exception_and_its_context(): void
    {
        ...
        $exception = new InvalidCallableException('message', 3, $previous, ['id' => 'service']);
    ...
    {
        $exception = new InvalidCallableException(context: ['id' => 'service', 'kept' => true]);
