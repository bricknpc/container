...
final class InvalidContextualBindingExceptionTest extends TestCase
{
    #[Test]
    public function it_carries_nothing_by_default(): void
    {
        $exception = new InvalidContextualBindingException();
    ...
    public function it_keeps_a_previous_exception_and_its_context(): void
    {
        ...
        $exception = new InvalidContextualBindingException('message', 3, $previous, ['id' => 'service']);
    ...
    {
        $exception = new InvalidContextualBindingException(context: ['id' => 'service', 'kept' => true]);
